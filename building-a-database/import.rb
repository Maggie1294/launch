...
# this can be deleted? Due to the code that we added below --------------
...
# don't we still need this if statement?
...
construction_types = csv_records.map { |record| record["construction_type"] }
construction_types.uniq!
